        ...
        <div className="relative">
          {!showInput ? (
            ...
            <form
              ...
              className="flex items-center gap-2 bg-gray-800 border border-gray-600 rounded-full px-4 py-2 shadow-lg focus-within:ring-2 focus-within:ring-amber-400 transition-all duration-300 w-full max-w-xs sm:max-w-sm md:max-w-md"
            >
              <input
                type="text"
